...
create table Base (ID integer primary key autoincrement, Name varchar(50), TypeID integer references Type(ID));
insert into Base (Name, TypeID) values('Satay Veg', 1);
insert into Base (Name, TypeID) values('Ham & Cheese', 3);
insert into Base (Name, TypeID) values('Hawaiian', 3);
insert into Base (Name, TypeID) values('Simply Cheese', 1);
insert into Base (Name, TypeID) values('Cheesy Pepperoni', 3);
insert into Base (Name, TypeID) values('Margherita with Fresh Tomato & Basil', 1);
insert into Base (Name, TypeID) values('Prawn, Bacon & Feta', 4);
insert into Base (Name, TypeID) values('GodFather', 2);
...
create table CountryBase (ID integer primary key autoincrement, CountryID integer references Country(ID), BaseID integer references Base(ID), BaseName varchar(50), BasePrice float, Tax float);
...
create table CountryTopping (ID integer primary key autoincrement, CountryID integer references Country(ID), ToppingID integer references Topping(ID), ToppingName varchar(50), ToppingPrice float, Tax float);
...
create table CountryCoins (ID integer primary key autoincrement, CountryID integer references Country(ID), Name varchar(50), Value float);
